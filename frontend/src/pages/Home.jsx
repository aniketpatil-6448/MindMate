  ...
  return (
    ...
    <div className='w-[100%] overflow-hidden'>
      ...
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <span className='lg:text-[70px] absolute  md:text-[40px]  lg:top-[8%] top-[15%] w-[100%] flex items-center justify-center text-white font-bold text-[20px] '>
          Mind Mate
        </span>
        <span className='lg:text-[35px] absolute  md:text-[40px]  lg:top-[17%] top-[15%] w-[100%] flex items-center justify-center text-white font-bold text-[20px] '>
          Where Questions Meet 
        </span>
        <span className='lg:text-[35px] text-[20px] md:text-[40px] absolute lg:top-[22%] top-[20%] w-[100%] flex items-center justify-center text-white font-bold'>
          Smart Solutions
        </span>
